...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test_no_mesh", action="store_true", help="test mode: do not save mesh"
    )
    parser.add_argument(
        "--camera_traj",
        type=str,
    ...
    parser.add_argument(
        "--train_split", type=str, default="train", choices=["train", "trainval", "all"]
    )
    parser.add_argument(
        "--preload",
        action="store_true",
    ...
    ### mesh options
    parser.add_argument(
        "--mcubes_reso", type=int, default=512, help="resolution for marching cubes"
    )
    parser.add_argument(
        "--env_reso", type=int, default=256, help="max layers (resolution) for env mesh"
    )
    parser.add_argument(
        "--decimate_target",
        type=int,
    ...
    parser.add_argument(
        "--visibility_mask_dilation", type=int, default=5, help="visibility dilation"
    )
    parser.add_argument(
        "--clean_min_f",
        type=int,
